...
mod builder_tests {
    ...
    fn test_builder_time_signal_with_segmentation_descriptor() {
        ...
        let descriptor = SegmentationDescriptorBuilder::new(1, SegmentationType::ProviderPlacementOpportunityStart)
        ...
        let encoded_bytes = {
            ...
            section.encode_with_crc().expect("Failed to encode with CRC")
        };
        ...
        assert_eq!(encoded_base64, expected_base64, 
        ...
        if let crate::descriptors::SpliceDescriptor::Segmentation(seg) = &reparsed_section.splice_descriptors[0] {
    ...
    fn test_builder_splice_insert_with_break_duration() {
        ...
        let section = SpliceInfoSectionBuilder::new()
            ...
            .splice_insert(splice_insert)
            .add_descriptor(crate::descriptors::SpliceDescriptor::Avail(avail_descriptor))
            .build()
            .unwrap();
        ...
        // Validate that our builder-generated payload matches the expected output
        let expected_base64 = "/DAvAAAAAAAA///wFAVIAACPf+/+c2nALv4AUsz1AAAAAAAKAAhDVUVJAAABNWLbowo=";
        assert_eq!(encoded_base64, expected_base64, 
            "Builder-generated payload does not match expected SCTE-35 output");
    ...
    fn test_builder_time_signal_immediate() {
        ...
        assert_eq!(reparsed_section.splice_command_type, 0x06); // TimeSignal
        if let crate::types::SpliceCommand::TimeSignal(ts) = &reparsed_section.splice_command {
            assert_eq!(ts.splice_time.time_specified_flag, 0, "Time signal should be immediate (time_specified_flag = 0)");
            assert!(ts.splice_time.pts_time.is_none(), "Time signal should be immediate (no pts_time)");
        } else {
            panic!("Expected TimeSignal command");
        }
    ...
    fn test_builder_splice_insert_immediate() {
        ...
        if let crate::types::SpliceCommand::SpliceInsert(si) = &reparsed_section.splice_command {
            ...
            assert_eq!(si.out_of_network_indicator, 1);
            assert_eq!(si.splice_immediate_flag, 1, "SpliceInsert should be immediate");
            assert!(si.splice_time.is_none(), "SpliceInsert should be immediate (no splice_time)");
        } else {
            panic!("Expected SpliceInsert command");
        }
    ...
    fn test_builder_time_signal_with_pts() {
        ...
        assert_eq!(reparsed_section.splice_command_type, 0x06); // TimeSignal
        if let crate::types::SpliceCommand::TimeSignal(ts) = &reparsed_section.splice_command {
            assert_eq!(ts.splice_time.time_specified_flag, 1, "Time signal should have time specified");
            assert!(ts.splice_time.pts_time.is_some(), "Time signal should have PTS time");
    ...
    fn test_builder_segmentation_descriptor() {
        ...
        use crate::builders::{SpliceInsertBuilder, SegmentationDescriptorBuilder, Upid};
        use crate::types::SegmentationType;
        use std::time::Duration;
        ...
        let descriptor = SegmentationDescriptorBuilder::new(0x12345, SegmentationType::ChapterStart)
            .upid(Upid::AdId("ABC123456789".to_string()))
            .unwrap()
        ...
        if let crate::descriptors::SpliceDescriptor::Segmentation(seg) = &reparsed_section.splice_descriptors[0] {
            ...
            assert_eq!(seg.segmentation_type_id, SegmentationType::ChapterStart.id());
    ...
    fn test_builder_sample_14_1_time_signal_placement_opportunity_start() {
        ...
        use crate::builders::{TimeSignalBuilder, SegmentationDescriptorBuilder, Upid};
        use crate::types::SegmentationType;
        use std::time::Duration;
        ...
        let descriptor = SegmentationDescriptorBuilder::new(0x4800008e, SegmentationType::ProviderPlacementOpportunityStart)
            .upid(Upid::AiringId(u64::from_be_bytes([
                airing_id_bytes[0], airing_id_bytes[1], airing_id_bytes[2], airing_id_bytes[3],
                airing_id_bytes[4], airing_id_bytes[5], airing_id_bytes[6], airing_id_bytes[7]
            ])))
            .unwrap()
            .delivery_restrictions(restrictions)
        ...
        let expected_base64 = "/DA0AAAAAAAA///wBQb+cr0AUAAeAhxDVUVJSAAAjn/PAAGlmbAICAAAAAAsoKGKNAIAmsnRfg==";
        assert_eq!(encoded_base64, expected_base64, 
    ...
    fn test_builder_sample_14_3_time_signal_placement_opportunity_end() {
        ...
        use crate::builders::{TimeSignalBuilder, SegmentationDescriptorBuilder, Upid, DeliveryRestrictions, DeviceRestrictions};
        use crate::types::SegmentationType;
        use std::time::Duration;
        ...
        let descriptor = SegmentationDescriptorBuilder::new(0x4800008e, SegmentationType::ProviderPlacementOpportunityEnd)
            .upid(Upid::AiringId(u64::from_be_bytes([
                airing_id_bytes[0], airing_id_bytes[1], airing_id_bytes[2], airing_id_bytes[3],
                airing_id_bytes[4], airing_id_bytes[5], airing_id_bytes[6], airing_id_bytes[7]
            ])))
        ...
        let expected_base64 = "/DAvAAAAAAAA///wBQb+dGKQoAAZAhdDVUVJSAAAjn+fCAgAAAAALKChijUCAKnMZ1g=";
        assert_eq!(encoded_base64, expected_base64, 
    ...
    fn test_builder_aws_mediatailor_cue_out() {
        ...
        let descriptor = SegmentationDescriptorBuilder::new(0x00000aa9, SegmentationType::ProviderPlacementOpportunityStart)
    ...
    fn test_builder_aws_mediatailor_cue_in() {
        ...
        let descriptor = SegmentationDescriptorBuilder::new(0x00000aa8, SegmentationType::ProviderPlacementOpportunityEnd)
        ...
        let expected_base64 = "/DA4AAAAAAAAAP/wBQb+tTeaawAiAiBDVUVJAAAKqH+/DBFNRFNOQjAwMTEzMjIxOTJfTjUAAIiGK1s=";
        assert_eq!(encoded_base64, expected_base64, 
